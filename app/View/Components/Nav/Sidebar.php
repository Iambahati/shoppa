...
class Sidebar extends Component
{
    ...
    private function buildNav(): array
    {
        ...
        return match(true) {
            ...
            $role === RoleName::Admin           => $this->adminNav(),
    ...
    private function adminNav(): array
    {
        return [
            ...
            ['label' => 'Queue',     'route' => 'verifier.queue',       'icon' => 'shield',  'active' => 'verifier.*'],
        ];
    }
    ...
    {
        return [
            ['label' => 'Dashboard', 'route' => 'admin.vendor-manager.dashboard', 'icon' => 'home',  'active' => 'admin.vendor-manager.dashboard'],
            ['label' => 'Vendors',   'route' => 'admin.vendors.index',            'icon' => 'store', 'active' => 'admin.vendors.*'],
        ];
    }
    ...
    {
        return [
            ['label' => 'Dashboard', 'route' => 'admin.cs.dashboard',    'icon' => 'home',       'active' => 'admin.cs.dashboard'],
    ...
    {
        return [
            ['label' => 'Dashboard', 'route' => 'admin.content.dashboard', 'icon' => 'home',    'active' => 'admin.content.dashboard'],
            ['label' => 'Products',  'route' => 'admin.products.index',    'icon' => 'package', 'active' => 'admin.products.*'],
        ];
    }
