            ...
            <table class="min-w-full divide-y divide-stone-100">
                ...
                <tbody class="divide-y divide-stone-100">
                    ...
                    <tr class="hover:bg-stone-50 transition-colors">
                        ...
                        <td class="table-td text-sm font-medium text-stone-900">{{ $listing->formattedPrice() }}</td>
                        <td class="table-td"><x-ui-badge color="stone">{{ ucfirst($listing->condition_grade ?? '—') }}</x-ui-badge></td>
                        <td class="table-td"><x-trust-cert-badge :status="$listing->verification_status ?? 'unverified'" /></td>
                        <td class="table-td text-stone-500">{{ $listing->quantity }}</td>
