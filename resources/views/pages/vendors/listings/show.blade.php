            ...
            <div class="card p-6">
                ...
                <dl class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <dd class="mt-1 text-sm font-mono text-stone-700">{{ $product->imei ?? '—' }}</dd>
                    </div>
                    <div>
                        <dt class="text-xs text-stone-400 uppercase tracking-wide">Serial number</dt>
                        <dd class="mt-1 text-sm font-mono text-stone-700">{{ $product->serial_number ?? '—' }}</dd>
                    </div>
            ...
            <div class="card p-5">
                ...
                <dl class="space-y-3">
                    ...
                    <div>
                        ...
                        <dd class="mt-1 text-sm text-stone-600">{{ $product->quantity }} unit(s)</dd>
                    </div>
                    <div>
                        <dt class="text-xs text-stone-400 uppercase tracking-wide">Category</dt>
                        <dd class="mt-1 text-sm text-stone-600">{{ $product->category?->name ?? '—' }}</dd>
                    </div>
                    <div>
                        <dt class="text-xs text-stone-400 uppercase tracking-wide">Listed</dt>
                        <dd class="mt-1 text-sm text-stone-500">{{ $product->created_at->format('d M Y') }}</dd>
                    </div>
                </dl>
            </div>
