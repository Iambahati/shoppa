{{-- DS trust mark: emerald capsule with filled check-badge glyph — the primary brand signal --}}
<span {{ $attributes->merge(['class' => $classes]) }}>
    {{-- Filled check-badge (solid) — the only trust glyph --}}
    ...
    {{ $slot->isNotEmpty() ? $slot : 'Shoppa Verified' }}
</span>
