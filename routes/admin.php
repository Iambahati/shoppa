...
Route::prefix('admin')->name('admin.')->middleware([
    ...
    Route::get('/vendor-manager/dashboard', [VendorManagerDashboardController::class, 'index'])
        ->middleware('role:Super Admin,Admin,Vendor Manager')
        ->name('vendor-manager.dashboard');

    Route::get('/cs/dashboard', [CustomerServiceDashboardController::class, 'index'])
        ->middleware('role:Super Admin,Admin,Customer Service')
        ->name('cs.dashboard');

    Route::get('/content/dashboard', [ContentManagerDashboardController::class, 'index'])
    ...
    // Products — Admin / Content Manager
